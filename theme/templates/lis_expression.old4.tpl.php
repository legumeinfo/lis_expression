...
<style>
  ...
  .active {background-color:#fff}  /* To make highlight persistent. JS function defined later in this template to make an item active(highlighted) on click. */
</style>
...
<div id="NavBar"  class="container">
  ...
  <ul class="navbar">
    ...
    <li  class="menu_item"><a  title="Show expression of gene family members"  href="javascript:void(0)" onclick="get_family_members_data ('display_data', datasetDropdown.value, geneUniquename, genus, species); "><b>GENE FAMILY <br/>MEMBERS</b></a></li>
    
    <li  class="menu_item"><a  title="Show metdata for the dataset and its samples"  href="javascript:void(0)" onclick="getDatasetMetadata(datasetDropdown.value);"><b>DATASET<br/> DETAILS</b></a></li>
    
    <li  class="menu_item"><a  title="Show expression of other genes with very similar expression pattern"  href="javascript:void(0)"  
        onclick="new_get_profile_neighbors_data ('display_data', datasetDropdown.value, geneUniquename, genus, species); ">
        <b>NEW PROFILE <br/>NEIGHBORS</b></a></li>
...
<hr>
NEW AJAX TESTING:
<a  title="Show expression of other genes with very similar expression pattern"  href="javascript:void(0)"  
        onclick="new_get_profile_neighbors_data ('display_data', datasetDropdown.value, geneUniquename, genus, species); ">
        <b>PROFILE <br/>NEIGHBORS</b></a>
<hr>
<div  id="controls-plot-type"></div>
<div  id="newgeneric">
